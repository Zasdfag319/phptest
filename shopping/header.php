		...
		<div class="container">
			<div class="row">
				<div class="col-xs-6 col-md-4 main-logo">
					<a href="index-1.php"><img src="images\logo.png" alt="logo" class="logo img-responsive"></a>
				</div>
				<div class="col-md-8">
					<div class="pushright">
						<div class="top">
					...
					<div class="col-md-10">
						...
						<div class="navbar-collapse collapse">
							<ul class="nav navbar-nav">
								<li><a href="index-1.php" class="active">Home</a><div class="curve"></div></li>
								<li class="dropdown menu-large">
									...
									<ul class="dropdown-menu megamenu container row">
										<li class="col-sm-4">
											<h4>Page Template</h4>
											<ul>
												<li><a href="index-1.php">Home Page</a></li>
												<li><a href="category.php">Category Page</a></li>
												<li><a href="category-list.php">Category List Page</a></li>
												<li><a href="category-fullwidth.php">Category fullwidth</a></li>
												<li><a href="product.php">Detail Product Page</a></li>
